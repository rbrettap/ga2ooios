...
// Constants
static NSString* const kGGTwitterLoadingBackgroundImage = @"mainbg.png";
...
//		_backgroundView.image = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"bg_raw" ofType:@"png"]];
	...
	_blockerView = [[[UIView alloc] initWithFrame: CGRectMake(0, 0, 210, 60)] autorelease];
	_blockerView.backgroundColor = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.6];
	_blockerView.layer.cornerRadius = 6.0;
	_blockerView.layer.borderColor = [[UIColor grayColor] CGColor];
	...
	UILabel	*label = [[[UILabel alloc] initWithFrame: CGRectMake(0, 15, _blockerView.bounds.size.width, 20)] autorelease];
	label.text = NSLocalizedString(@"Please wait…", nil);
	//label.font = [UIFont fontWithName:@"Knockout-HTF31-JuniorMiddlewt" size:17.0];
	...
	spinner.center = CGPointMake(_blockerView.bounds.size.width / 2, _blockerView.bounds.size.height / 2 + 17);
	[_blockerView addSubview: spinner];
	[self.view addSubview: _blockerView];
	[spinner startAnimating];
	UINavigationItem *navItem = [[[UINavigationItem alloc] initWithTitle: NSLocalizedString(@"Twitter Login", nil)] autorelease];
	...
	_navBar.tintColor =  [UIColor colorWithRed:1.0/255.0 green:60.0/255.0 blue:83.0/255.0 alpha:1];//[UIColor colorWithRed:255.0/255.0 green:200.0/255.0 blue:34.0/255.0 alpha:1.0];	
